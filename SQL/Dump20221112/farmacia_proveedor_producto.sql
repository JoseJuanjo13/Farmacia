...
CREATE TABLE `proveedor_producto` (
  ...
  KEY `nit_proveedor_idx` (`nit_proveedor`),
  KEY `producto_id_idx` (`producto_id`),
  CONSTRAINT `nit_proveedor` FOREIGN KEY (`nit_proveedor`) REFERENCES `proveedor` (`nit`),
  CONSTRAINT `producto_id` FOREIGN KEY (`producto_id`) REFERENCES `producto` (`id_producto`)
...
-- Dump completed on 2022-11-26 23:07:50
